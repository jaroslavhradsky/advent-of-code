...
public class Day01 {
    public static void main(String[] args){
        ...
        TreeSet<Integer> frequencyStates = new TreeSet<>();
        int frequency = 0;
        frequencyStates.add(frequency);
        
        // -------------------- Part 1 -------------------- Your puzzle answer was 590.
        ...
        // -------------------- Part 2 -------------------- Your puzzle answer was 83445.
        int i = 0;
        frequency += changes.get(i++);
        while (!frequencyStates.contains(frequency)){
            frequencyStates.add(frequency);
            frequency += changes.get(i++%1023);
        }
